...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>月租金</label>
										<input id="yuezujin" name="yuezujin" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>租赁时间</label>
										<input id="zulinshijian" name="zulinshijian" class="form-control" onchange="calculation()">
									</div>
									<div class="form-group col-md-6">
										<label>总租金</label>
	...
	<script>
		...
		function calculation(){
			...
			var y = 0;
			var flag = 0;
			if($("#yuezujin").val() != null && $("#yuezujin").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#yuezujin").val());
					flag++;
				}else{
					x = x * parseFloat($("#yuezujin").val());
					flag++;
				}
			}
			if($("#zulinshijian").val() != null && $("#zulinshijian").val() != ""){
				if(x == 0 && flag < 2){
					x = (x+1) * parseFloat($("#zulinshijian").val());
					flag++;
				}else{
					x = x * parseFloat($("#zulinshijian").val());
					flag++;
				}
			}
			if(flag < 2){
