...
<body>
							...
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>房间号</label>
										<input id="fangjianhao" name="fangjianhao" class="form-control" placeholder="房间号">
									</div>
									<div class="form-group col-md-6">
										<label>房屋名称</label>
									...
									<div class="form-group col-md-6">
										<label>房型</label>
										<select id="fangxingSelect" name="fangxing" class="form-control">
												<option value=""></option>
												<option class="fangxingOption" value="电梯房">
													电梯房
												</option>
												<option class="fangxingOption" value="步梯房">
													步梯房
												</option>
										</select>	
									</div>	
									...
									<div class="form-group col-md-6">
										<label>月租金</label>
										<input id="yuezujin" name="yuezujin" class="form-control" placeholder="月租金">
									</div>
									<div class="form-group col-md-6">
										<label>咨询电话</label>
										<input id="zixundianhua" name="zixundianhua" class="form-control" placeholder="咨询电话">
									</div>
									<div class="form-group col-md-6">
										<label>地区</label>
										<input id="diqu" name="diqu" class="form-control" placeholder="地区">
									</div>
									<div class="form-group col-md-6">
										<label>详细地址</label>
									...
									<div class="form-group col-md-6">
										...
										<select id="zhuangtaiSelect" name="zhuangtai" class="form-control">
												<option value=""></option>
												<option class="zhuangtaiOption" value="待出租">
													待出租
												</option>
												<option class="zhuangtaiOption" value="已出租">
													已出租
												</option>
										</select>	
									</div>	
	...
	<script>
		...
		function dataBind(){
			...
			var fangxingOptions = document.getElementsByClassName("fangxingOption");
			for(var fangxingCount = 0; fangxingCount < fangxingOptions.length;fangxingCount++){
				if(fangxingOptions[fangxingCount].getAttribute('value') == ruleForm.fangxing){
					fangxingOptions[fangxingCount].setAttribute('selected','selected');
				}
			}
			$("#mianji").val(ruleForm.mianji);	
			$("#yuezujin").val(ruleForm.yuezujin);	
		...
		if(crossTableName != null && crossTableName != '' && crossTableId != null && crossTableId != '' && crossTableId != -1){
			http(crossTableName + "/info/" + crossTableId,"GET",{},(res)=>{
				if(res.code == 0){
					...
					if(res.data != null && res.data != '' && res.data.fangxing != null && res.data.fangxing != ''){

					var fangxingOptions = document.getElementsByClassName("fangxingOption");
						for(var fangxingCount = 0; fangxingCount < fangxingOptions.length;fangxingCount++){
							if(fangxingOptions[fangxingCount].getAttribute('value') == res.data.fangxing){
								fangxingOptions[fangxingCount].setAttribute('selected','selected');
							}
						}
					}
					...
					if(res.data != null && res.data != '' && res.data.yuezujin != null && res.data.yuezujin != ''){

					$("#yuezujin").val(res.data.yuezujin);
					}
