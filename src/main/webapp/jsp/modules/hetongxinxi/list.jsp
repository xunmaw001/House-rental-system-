...
<body>
						...
						<div class="widget-area-2 lochana-box-shadow">
							...
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="hetongbianhaoSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										房屋类型
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('zongzujin')">总租金<i id="zongzujinIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var zongzujinCell  = document.createElement('td');

						 zongzujinCell.innerHTML = item.zongzujin;


			row.appendChild(zongzujinCell);
			...
			var hetongneirongCell  = document.createElement('td');
						  ...
						  if(item.hetongneirong != null && item.hetongneirong != "" && item.hetongneirong.length >= 11){
			  	hetongneirongCell.innerHTML = item.hetongneirong.substring(0, 10) + "..."; 
			  }else{
			  	hetongneirongCell.innerHTML = item.hetongneirong;
			  }
			...
			var hetongwenjianCell  = document.createElement('td');
			  ...
			  var hetongwenjianFileAttr = "download('" + item.hetongwenjian + "')"
