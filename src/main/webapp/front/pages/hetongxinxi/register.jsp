            ...
            <article>
                ...
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="fangwumingcheng" name="fangwumingcheng" placeholder="请输入房屋名称" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="fangwuleixing" name="fangwuleixing" placeholder="请输入房屋类型" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                ...
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="zongzujin" name="zongzujin" placeholder="请输入总租金" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="zulinshijian" name="zulinshijian" placeholder="请输入租赁时间" autocomplete="off" class="layui-input">
                  </div>
                </div>
                <div class="layui-form-item layui-form-text input">
                  <div class="layui-input-inline" style="width: 300px;">
                    <input type="text" id="youxiaoqi" name="youxiaoqi" placeholder="请输入有效期" autocomplete="off" class="layui-input">
                  </div>
                </div>
