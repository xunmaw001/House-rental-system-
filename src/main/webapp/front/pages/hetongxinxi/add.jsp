			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.hetongbianhao" type="text" name="hetongbianhao" id="hetongbianhao" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zongzujin" type="text" name="zongzujin" id="zongzujin" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.zulinshijian" type="text" name="zulinshijian" id="zulinshijian" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                            <div class="layui-form-item" pane>
						...
						<div class="layui-input-inline" style="line-height: 50px;">
                            ...
                            <button type="button" class="layui-btn btn-theme" id="hetongwenjianUpload">
								<i class="layui-icon">&#xe67c;</i>上传合同文件
							</button>
							<a download="合同文件" :href="detail.hetongwenjian">点击下载合同文件</a>
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<input v-model="detail.youxiaoqi" type="text" name="youxiaoqi" id="youxiaoqi" autocomplete="off" class="layui-input">
						</div>
					</div>
