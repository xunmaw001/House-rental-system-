		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="zongzujin" type="text" name="zongzujin" id="zongzujin" disabled="disabled" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
		...
		<script>
			...
			var vue = new Vue({
                ...
                computed: {
                                                                                                                                                                                                                                                                                                                                                                        zongzujin:{
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                get: function () {
                        return 1*this.detail.yuezujin*this.detail.zulinshijian
                    }
                    },
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            },
				methods: {
