        ...
        <div class="ng-inmod-ini">
          <div class="ng-fault ng-container">
            <div class="ng-inmod-the ng-container ng-bg-fff">
              ...
              <span class="ng-inmod-the-cn" aos="fade-down">房屋信息展示</span><span class="ng-inmod-the-en" aos="fade-up">DATA SHOW</span>
            </div>
          ...
          <fieldset class="search-container" style="text-align: center;">
            <form class="layui-form">
              ...
              <div class="layui-inline" style="margin-bottom: 10px;">
                ...
                <div class="layui-input-inline">
                  <input type="text" name="yuezujin" id="yuezujin" placeholder="月租金" autocomplete="off" class="layui-input">
                </div>
              </div>   
              <div class="layui-inline" style="margin-bottom: 10px;">
                <label class="layui-form-label">地区</label>
                <div class="layui-input-inline">
                  <input type="text" name="diqu" id="diqu" placeholder="地区" autocomplete="off" class="layui-input">
                </div>
              </div>   
              ...
              <ul>
                <li v-for="(item,index) in dataList" v-bind:key="index">
                  <div class="ng-prslist-doc">
                    <div class="ng-prslist-img" @click="jump('../fangwuxinxi/detail.jsp?id='+item.id)">
                    ...
                    <div class="ng-prslist-tit" @click="jump('../fangwuxinxi/detail.jsp?id='+item.id)"><span>{{item.fangwumingcheng}}</span></div>
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#yuezujin').val()) {
          param['yuezujin'] = jquery('#yuezujin').val() ? '%' + jquery('#yuezujin').val() + '%' : '';
        }  
        if (jquery('#diqu').val()) {
